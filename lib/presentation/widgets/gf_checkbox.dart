...
class GFCustomCheckbox extends StatefulWidget {
  /// [GFCustomCheckbox] is a small box (as in a checklist) in which to place a check mark to make a selection with various customization options.
  const GFCustomCheckbox({
    Key? key,
  ...
  @override
  _GFCustomCheckboxState createState() => _GFCustomCheckboxState();
}

class _GFCustomCheckboxState extends State<GFCustomCheckbox> {
